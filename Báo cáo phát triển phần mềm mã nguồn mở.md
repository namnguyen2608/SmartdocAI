...
Biểu đồ đường cho thấy rõ đặc tính của từng thuật toán: FAISS dao động quanh mức 35–37ms không tăng đơn điệu vì **encode câu hỏi (~40ms) chiếm >95% tổng latency**, che lấp hoàn toàn thời gian search vector thực tế (0.1–1.5ms) — đây là đặc tính thật của hệ thống, không phải nhiễu đo lường. BM25 tăng tuyến tính rõ rệt (1.48ms → 21.89ms) vì không có encode, toàn bộ thời gian là duyệt inverted index tỉ lệ thuận với kích thước dữ liệu. Hybrid Search tăng đều và nhất quán (37.95ms → 60.52ms), phản ánh overhead tổng hợp FAISS + BM25 + Reciprocal Rank Fusion.
...
# **CHƯƠNG VI: YÊU CẦU PHÁT TRIỂN (Q1–Q10)**
...
## **6.1. Q1 — Xử Lý Tài Liệu Đa Định Dạng (PDF & DOCX)**
...
## **6.2. Q2 — Lưu Trữ Lịch Sử Hội Thoại**
...
## **6.3. Q3 — Xóa Lịch Sử và Vector Store**
...
## **6.4. Q4 — Chunking Tài Liệu (Phân Đoạn Văn Bản)**
...
## **6.5. Q5 — Citation Tracking (Truy Dấu Nguồn)**
...
## **6.6. Q6 — Conversational RAG (Hội Thoại Đa Lượt)**
...
## **6.7. Q7 — Hybrid Search (FAISS + BM25)**
...
## **6.8. Q8 — Metadata Filtering (Lọc Theo Tài Liệu Nguồn)**
...
## **6.9. Q9 — Cross-Encoder Re-Ranking**
...
## **6.10. Q10 — Self-RAG (Tự Đánh Giá và Cải Thiện)**
