...
| PyPDF2 / pypdf | >=3.0.0 / >=4.0.0 | Trích xuất văn bản từ PDF |
...
* **Định dạng lịch sử hội thoại**: lưu dưới dạng list xen kẽ `HumanMessage` / `AIMessage` từ LangChain — không dùng string thô — vì các lớp này type-safe và tương thích trực tiếp với pipeline reformulation.
